...
<head>
    ...
    <style>
        * {
        ...
        /* Miscellaneous pattern background */
        body::before {
            content: "";
            position: absolute;
            top: 0;
...
<body>
    ...
    <div class="container">
        <div class="header">
            <h1>Miscellaneous File Manager</h1>
            <p>Upload and download miscellaneous documents for BMB.</p>
        </div>
        ...
        <div class="tab-content active" id="upload-tab">
            <div class="upload-container">
                <form id="uploadForm" enctype="multipart/form-data" method="post" action="ftp_manager_miscellaneous.php">
                ...
                <div class="form-notice">
                    This application should be used only for Buymeabook miscellaneous document activities.
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            uploadForm.addEventListener('submit', function(e) {
                ...
                xhr.open('POST', 'ftp_manager_miscellaneous.php', true);
                xhr.send(formData);
            });
            ...
            function downloadFile(filename) {
                ...
                form.method = 'POST';
                form.action = 'ftp_manager_miscellaneous.php';
