...
<head>
    ...
    <title>Access Denied - Manager Portal</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        body {
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            background: linear-gradient(135deg, #2d1b69 0%, #0f3460 50%, #16c79a 100%);
            height: 100vh;
            display: flex;
    ...
    <div class="error-container">
        ...
        <p class="error-message">
            ...
            if (isset($_SESSION['access_error'])) {
                ...
                echo "You do not have sufficient privileges to access the Manager Portal.";
            }
            ?>
        </p>
