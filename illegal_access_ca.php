...
<head>
    ...
    <title>Access Denied - Accounting System</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        body {
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            background: linear-gradient(135deg, #0f1a42 0%, #3a1d6e 50%, #4a3b9e 100%);
            height: 100vh;
            display: flex;
    ...
    <div class="error-container">
        ...
        <p class="error-message">
            ...
            if (isset($_SESSION['access_error'])) {
                ...
                echo "You do not have sufficient privileges to access the Accounting System.";
            }
            ?>
        </p>
