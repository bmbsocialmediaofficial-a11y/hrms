...
<body>
    ...
    <div class="container">
        <div class="header">
            <h1>Testing File Manager</h1>
            <p>Upload and download documents related to BMB Testing.</p>
        </div>
        ...
        <div class="tab-content active" id="upload-tab">
            <div class="upload-container">
                <form id="uploadForm" enctype="multipart/form-data" method="post" action="ftp_manager_testing.php">
                ...
                <div class="form-notice">
                    This application should be used only for Buymeabook testing related activities.
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            uploadForm.addEventListener('submit', function(e) {
                ...
                xhr.open('POST', 'ftp_manager_testing.php', true);
                xhr.send(formData);
            });
            ...
            function downloadFile(filename) {
                ...
                form.method = 'POST';
                form.action = 'ftp_manager_testing.php';
