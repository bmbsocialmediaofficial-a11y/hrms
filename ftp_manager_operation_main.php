...
<head>
    ...
    <style>
        * {
        ...
        .progress {
            height: 100%;
            background: linear-gradient(90deg, #4a6fc0, #2e59d9);
            width: 0%;
...
<body>
    ...
    <div class="container">
        <div class="header">
            <h1>Operations File Manager</h1>
            <p>Upload and download documents related to BMB Operations.</p>
        </div>
        ...
        <div class="tab-content active" id="upload-tab">
            <div class="upload-container">
                <form id="uploadForm" enctype="multipart/form-data" method="post" action="ftp_upload.php">
                ...
                <div class="form-notice">
                    This application should be used only for Buymeabook operation related activities.
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            uploadForm.addEventListener('submit', function(e) {
                ...
                xhr.open('POST', 'ftp_manager_operation.php', true);
                xhr.send(formData);
            });
            ...
            function downloadFile(filename) {
                ...
                // Use direct FTP download for better performance
                const xhr = new XMLHttpRequest();
                xhr.open('POST', 'ftp_manager_operation.php', true);
                xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                    ...
                    if (xhr.status === 200) {
                        try {
                            ...
                            if (response.success && response.download_url) {
                                ...
                                downloadResult.textContent = 'Failed to prepare download: ' + (response.message || 'Unknown error');
                ...
                xhr.send('action=get_download_url&file_name=' + encodeURIComponent(filename));
            }
            
            function fallbackDownload(filename) {
                // Create a form and submit it to trigger the download (original method)
                const form = document.createElement('form');
                form.method = 'POST';
                form.action = 'ftp_manager_operation.php';
