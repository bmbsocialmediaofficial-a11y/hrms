...
<head>
    ...
    <title>Access Denied - Admin System</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        body {
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            background: linear-gradient(135deg, #0a2f2f 0%, #1d6e4a 50%, #2d9e7f 100%);
            height: 100vh;
            display: flex;
    ...
    <div class="error-container">
        ...
        <p class="error-message">
            ...
            if (isset($_SESSION['access_error'])) {
                ...
                echo "You do not have sufficient privileges to access the Admin System.";
            }
            ?>
        </p>
